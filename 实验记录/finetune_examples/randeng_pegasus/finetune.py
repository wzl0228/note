...
def create_data(data, tokenizer, max_len=256, term='train'):
...
if __name__ == '__main__':
    ...
    model = PegasusForConditionalGeneration.from_pretrained(args.pretrain_model).to(device)
    if args.data_parallel and torch.cuda.is_available():
    ...
    # {'rouge-1': 0.34674247715615736, 'rouge-2': 0.18312193147450487, 'rouge-l': 0.296289224162275}