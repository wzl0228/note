...
prefix_state_dict = torch.load(os.path.join("ptuning/output/adgen-chatglm-6b-pt-Ques-256-2e-2/checkpoint-600", "pytorch_model.bin"))
...
if __name__ == '__main__':    
    ...
    parser.add_argument("-data_path", default='ptuning/data0805/Ques/test.json', type=str)
    parser.add_argument('--result_file', default='ptuning/data0805/Ques/test_result.json')
    args = parser.parse_args()
    QueG(args)

# {'rouge-1': 0.5914488296496648, 'rouge-2': 0.4669579282708447, 'rouge-l': 0.568488757013665}

# 调整重新生成一次 {'rouge-1': 0.6050794074328815, 'rouge-2': 0.4784346027611186, 'rouge-l': 0.5830977531804548}
