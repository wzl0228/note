...
def init_argument():
    ...
    parser.add_argument('--test_data', default='data_utils/data0805/Sugg/test.json')
    # parser.add_argument('--result_file', default='filtered_data/test_result.tsv')
    parser.add_argument('--result_file', default='data_utils/data0805/Sugg/test_result.json')
    parser.add_argument('--pretrain_model', default='t5_pegasus_pretrain')    
    parser.add_argument('--model', default='saved_model/Sugg_0805/summary_model')

    parser.add_argument('--batch_size', default=1, help='batch size') # 16->1
    parser.add_argument('--max_len', default=800, help='max length of inputs')
    parser.add_argument('--max_len_generate', default=500, help='max length of generated text')
...
# {'rouge-1': 0.6482157567699584, 'rouge-2': 0.5433948555935273, 'rouge-l': 0.6296467794891385}
# 重新生成后：{'rouge-1': 0.6482157567699584, 'rouge-2': 0.5433948555935273, 'rouge-l': 0.6296467794891385}
