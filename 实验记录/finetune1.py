...
def init_argument():
    ...
    parser.add_argument('--train_data', default='data_utils/data0805/Sugg/train.json')
    parser.add_argument('--dev_data', default='data_utils/data0805/Sugg/dev.json')
    parser.add_argument('--pretrain_model', default='t5_pegasus_pretrain') # 可以换small
    # parser.add_argument('--model_dir', default='saved_model')
    parser.add_argument('--model_dir', default='saved_model/Sugg_0805')
    ...
    parser.add_argument('--max_len', default=800, help='max length of inputs') # 729
    parser.add_argument('--max_len_generate', default=500, help='max length of outputs') # 460
